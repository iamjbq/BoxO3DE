...
namespace B3
{
    ...
    //! Request bus for box collider.
    class EditorBoxColliderComponentRequests
        : public AZ::EntityComponentBus
    {
    public:
    ...
    using EditorBoxColliderComponentRequestBus = AZ::EBus<EditorBoxColliderComponentRequests>;
    
    //! Request bus for sphere collider.
    class EditorSphereColliderComponentRequests
        : public AZ::EntityComponentBus
    {
    public:
    ...
    using EditorSphereColliderComponentRequestBus = AZ::EBus<EditorSphereColliderComponentRequests>;
    
    //! Request bus for capsule collider.
    class EditorCapsuleColliderComponentRequests
        : public AZ::EntityComponentBus
    {
    public:
    ...
    using EditorCapsuleColliderComponentRequestBus = AZ::EBus<EditorCapsuleColliderComponentRequests>;
    
    //! Request bus for cylinder collider.
    class EditorCylinderColliderComponentRequests
        : public AZ::EntityComponentBus
    {
    public:
    ...
    using EditorCylinderColliderComponentRequestBus = AZ::EBus<EditorCylinderColliderComponentRequests>;
    ...
    //! Request bus for colliders using Box3D mesh assets.
    ...
    {
    public:
        //! Checks if the mesh in the collider is correct with the current state of the Rigidbody.

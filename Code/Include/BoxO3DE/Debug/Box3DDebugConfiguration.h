...
namespace B3
{
    namespace Debug
    {
        ...
        {
            AZ_TYPE_INFO(ColliderProximityVisualization, "{0791CFF0-8892-4857-AE91-5EC90E336407}");
            static void Reflect(AZ::ReflectContext* context);
        ...
        //! Contains various options for debug display of Box3D features.
        struct DebugDisplayData
        {
            AZ_TYPE_INFO(DebugDisplayData, "{BD6BD51D-BECC-4C2A-9BF2-6B29BF31D89D}");
            static void Reflect(AZ::ReflectContext* context);
        ...
        {
            AZ_TYPE_INFO(DebugConfiguration, "{5CA6512E-D0D0-4A22-A0F5-5F44953B672D}");
            static void Reflect(AZ::ReflectContext* context);

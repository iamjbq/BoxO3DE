...
namespace B3
{
    ...
    //     AZ_TYPE_INFO(EditorProxyCylinderShapeConfig, "{1EBDE161-A56D-4DE5-B855-A5C16ED124A8}");
    ...
    struct EditorProxyShapeConfig
    {
        ...
        AZ_TYPE_INFO(EditorProxyShapeConfig, "{B7D9FB6F-8A23-43E4-B56E-09E0579A2FF2}");
        static void Reflect(AZ::ReflectContext* context);
    ...
    //! Editor Box3D Primitive Shape Collider Component.
    ...
    {
    public:
        AZ_EDITOR_COMPONENT(EditorShapeColliderComponent, "{D1480E95-E818-44FF-B542-593BCFD00CEB}");
        ...
        EditorShapeColliderComponent() = default;
    ...
    private:
        AZ_DISABLE_COPY_MOVE(EditorShapeColliderComponent);
        ...
        // B3::ColliderShapeBus overrides ...
        AZ::Aabb GetColliderShapeAabb() override;
        bool IsTrigger() override;

        // B3::EditorColliderComponentRequestBus overrides ...
        ...
        // B3::EditorPrimitiveColliderComponentRequestBus overrides ...

...
namespace B3
{
    void EditorStaticRigidBodyComponent::Reflect(AZ::ReflectContext* context)
    {
        if (auto* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            {
                constexpr const char* ToolTip = "The entity behaves as a non-movable rigid body in Box3D.";
                constexpr const char* HelpPageURL = "https://github.com/erincatto/box3d/blob/main/docs/simulation.md";

                editContext->Class<EditorStaticRigidBodyComponent>("Box3D Static Rigid Body", ToolTip)
                    ...
                    ->Attribute(
                        ...
                        Physics::NameConstants::GetBulletPoint() + " Its purpose is to be a non-movable rigid body in Box3D. <a href=\"" + HelpPageURL + "\">Read more</a>");
            }
        }
    }

...
#include <Tools/System/KinematicDescriptionDialog.h>
...
namespace B3
{
    namespace Internal
    {
        AZStd::vector<AZStd::shared_ptr<Physics::Shape>> CreateCollisionShapes(AZ::Entity* entity)
        {
            ...
            // TODO: this will become the shared shape collider if implemented
    ...
    static void OpenBox3DConfigurationPane()
    {
        AzToolsFramework::EditorRequestBus::Broadcast(
            &AzToolsFramework::EditorRequests::OpenViewPane, LyViewPane::Box3DConfigurationEditor);
    }
    ...
    static AzToolsFramework::GenericEditResultOutcome<bool> OnEditButtonClicked(bool comboBoxValue)
    {
        ...
        B3::Editor::KinematicDescriptionDialog kinematicDialog(comboBoxValue, mainWindow);
        ...
        if (serializeContext)
        {
            ...
            if (editContext)
            {
                editContext->Class<AzPhysics::RigidBodyConfiguration>(
                    "Box3D Rigid Body Configuration", "")
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Default, &AzPhysics::RigidBodyConfiguration::m_ccdEnabled,
                        ...
                        "collision detection, particularly for fast moving rigid bodies. CCD must be activated in the global Box3D configuration.")
                        ->Attribute(AZ::Edit::Attributes::Visibility, &AzPhysics::RigidBodyConfiguration::GetCcdVisibility)
                    ...
                    ->DataElement(
                        ...
                        "",
                        "Click here to open the Box3D Configuration window. Enable global CCD to enable component CCD editing.")
                        ->Attribute(AZ::Edit::Attributes::ButtonText, "Open Box3D Configuration to Enable CCD")
                    ->Attribute(AZ::Edit::Attributes::Visibility, &IsSceneCcdDisabled)
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &OpenBox3DConfigurationPane)
                    ->EndGroup()
    ...
    void EditorRigidBodyComponent::OnEntityActivated(const AZ::EntityId& entityId)
    {
        ...
        //     entityId, &B3::EditorMeshColliderValidationRequestBus::Events::ValidateRigidBodyMeshGeometryType);
    ...
    void EditorRigidBodyComponent::OnConfigurationChanged()
    {
        ...
        // B3::EditorMeshColliderValidationRequestBus::Event(
        //     GetEntityId(), &B3::EditorMeshColliderValidationRequestBus::Events::ValidateRigidBodyMeshGeometryType);
    }
    ...
    void EditorRigidBodyComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (serializeContext)
        {
            serializeContext->Class<EditorRigidBodyComponent, AzToolsFramework::Components::EditorComponentBase>()
                ...
                ->Field("Box3DSpecificConfiguration", &EditorRigidBodyComponent::m_box3DSpecificConfig)
                ->Version(1)
            ;
            ...
            if (editContext)
            {
                editContext->Class<EditorRigidBodyComponent>(
                    "Box3D Dynamic Rigid Body", "The entity behaves as a movable rigid body in Box3D.")
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                    ->Attribute(AZ::Edit::Attributes::Category, "Box3D")
                    ...
                    ->DataElement(
                        AZ::Edit::UIHandlers::Default,
                        &EditorRigidBodyComponent::m_box3DSpecificConfig,
                        "Box3D-Specific Configuration",
                        "Settings which are specific to Box3D, rather than generic.")
                    ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, &EditorRigidBodyComponent::OnConfigurationChanged)
                    ;
            }
    ...
    EditorRigidBodyComponent::EditorRigidBodyComponent(
        const EditorRigidBodyConfiguration& configuration, const RigidBodyConfiguration& box3DSpecificConfiguration)
        : m_config(configuration)
        , m_box3DSpecificConfig(box3DSpecificConfiguration)
    {
        InitPhysicsTickHandler();
    }
    ...
    void EditorRigidBodyComponent::BuildGameEntity(AZ::Entity* gameEntity)
    {
        ...
        gameEntity->CreateComponent<RigidBodyComponent>(m_config, m_box3DSpecificConfig, AzPhysics::InvalidSceneHandle);
    }
    ...
    void EditorRigidBodyComponent::CreateEditorWorldRigidBody()
    {
        ...
        configuration.m_startSimulationEnabled = false; // TODO: disabled bodies don't do anything in Box3D. Unsure what to do here

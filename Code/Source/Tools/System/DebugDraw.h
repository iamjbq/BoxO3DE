...
namespace B3
{
    namespace DebugDraw
    {
        //! Open the Box3D Settings Window on the Global Settings tab.
        ...
        public:
            ...
            AZ_RTTI(Collider, "{C8D11FB5-427C-48A5-A2B4-8AC4E52D21FE}");
        ...
        protected:
            ...
            void BuildConvexMesh(b3HullData* hullData, AZ::u32 geomIndex) const;
            ...
            B3::Debug::DebugDisplayDataChangedEvent::Handler m_debugDisplayDataChangedEvent;
        };
    } // namespace DebugDraw
} // namespace B3

...
namespace B3
{
    namespace Editor
    {
        ...
        void CollisionLayersWidget::SetPropertyEditingComplete(AzToolsFramework::InstanceDataNode* node)
        {
            ...
            {
                AZ_Warning("Box3D Collision Layers"
                    , false
            ...
            , AZStd::string& uniqueLayerNameOut)
        {
            ...
            {
                AZ_Warning("Box3D Collision Layers", false, "Trying to validate layer name of layer with invalid index: %d", layerIndex);
                return false;
            }
...
#include <Tools/System/moc_CollisionLayersWidget.cpp>

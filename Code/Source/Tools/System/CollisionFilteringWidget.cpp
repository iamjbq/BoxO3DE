...
#include <Tools/System/CollisionLayersWidget.h>
#include <Tools/System/CollisionGroupsWidget.h>
...
namespace B3
{
    namespace Editor
    {
            ...
            : QWidget(parent)
        {
            ...
            m_documentationLinkWidget = new DocumentationLinkWidget(s_collisionFilteringLink, (UXNameConstants::GetBox3DDocsRoot() + s_collisionFilteringAddress).c_str());
...
#include <Tools/System/moc_CollisionFilteringWidget.cpp>

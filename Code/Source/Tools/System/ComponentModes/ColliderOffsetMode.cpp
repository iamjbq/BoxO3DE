...
namespace B3
{
    ...
    void ColliderOffsetMode::OnManipulatorMoved(const AZ::Vector3& startPosition, const AZ::Vector3& offset, const AZ::EntityComponentIdPair& idPair)
    {
        ...
        B3::EditorColliderComponentRequestBus::Event(idPair, &B3::EditorColliderComponentRequests::SetColliderOffset, newPosition);
    }

    void ColliderOffsetMode::ResetValues(const AZ::EntityComponentIdPair& idPair)
    {
        B3::EditorColliderComponentRequestBus::Event(idPair, &B3::EditorColliderComponentRequests::SetColliderOffset, AZ::Vector3::CreateZero());
    }
}

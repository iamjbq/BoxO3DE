...
namespace B3
{
    ...
    void ColliderRotationMode::Setup(const AZ::EntityComponentIdPair& idPair)
    {
        ...
        B3::EditorColliderComponentRequestBus::EventResult(colliderRotation, idPair, &B3::EditorColliderComponentRequests::GetColliderRotation);

        AZ::Vector3 colliderOffset;
        B3::EditorColliderComponentRequestBus::EventResult(colliderOffset, idPair, &B3::EditorColliderComponentRequests::GetColliderOffset);
            ...
            (const AzToolsFramework::AngularManipulator::Action& action)
        {
            ...
            B3::EditorColliderComponentRequestBus::Event(idPair, &B3::EditorColliderComponentRequests::SetColliderRotation, action.LocalOrientation());
        });
    ...
    {
        B3::EditorColliderComponentRequestBus::Event(idPair, &B3::EditorColliderComponentRequests::SetColliderRotation, AZ::Quaternion::CreateIdentity());
    }

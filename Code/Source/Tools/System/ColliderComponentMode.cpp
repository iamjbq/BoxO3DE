...
#include <Tools/System/ComponentModes/ColliderBoxMode.h>
#include <Tools/System/ComponentModes/ColliderCapsuleMode.h>
#include <Tools/System/ComponentModes/ColliderCylinderMode.h>
#include <Tools/System/ComponentModes/ColliderOffsetMode.h>
#include <Tools/System/ComponentModes/ColliderRotationMode.h>
#include <Tools/System/ComponentModes/ColliderSphereMode.h>
...
namespace B3
{
    namespace
    {
        ...
        const AZ::Crc32 SetDimensionsSubModeActionUri = AZ_CRC_CE("org.o3de.action.box3d.setdimensionssubmode");
        const AZ::Crc32 SetOffsetSubModeActionUri = AZ_CRC_CE("org.o3de.action.box3d.setoffsetsubmode");
        const AZ::Crc32 SetRotationSubModeActionUri = AZ_CRC_CE("org.o3de.action.box3d.setrotationsubmode");
        const AZ::Crc32 ResetSubModeActionUri = AZ_CRC_CE("org.o3de.action.box3d.resetsubmode");
    } // namespace
    ...
    void ColliderComponentMode::CreateSubModeSelectionCluster()
    {
        ...
        const auto onButtonClicked = [this](AzToolsFramework::ViewportUi::ButtonId buttonId)
        {
            ...
            {
                AZ_Error("Box3D Collider Component Mode", false, "Unrecognized button ID.");
            }
        };

...
namespace B3
{
    namespace Editor
    {
        ...
        bool RowHeader::SanitizeGroupName(AZStd::string& groupNameOut)
        {
            ...
            if (nameModified)
            {
                AZ_Warning("Jolt Collision Groups"
                    , false
        ...
        {
            AZStd::vector<B3::Editor::RowHeader::Data> rows = GetRows();
            AZStd::vector<B3::Editor::ColumnHeader::Data> columns = GetColumns();
...
#include <Tools/System/moc_CollisionGroupsWidget.cpp>

...
namespace B3
{
    ...
    public:
        ...
        AZ_RTTI(ColliderComponentMode, "{357AEC18-A05B-4B7E-9AC9-55A01692E332}", EditorBaseComponentMode)
    ...
    private:
        ...
        AZStd::unordered_map<SubMode, AZStd::unique_ptr<Box3DSubComponentModeBase>> m_subModes;

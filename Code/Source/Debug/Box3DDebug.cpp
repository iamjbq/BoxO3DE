...
namespace B3
{
    namespace Debug
    {
//         physx::PxPvd* Box3DDebug::InitializePhysXPvd([[maybe_unused]] physx::PxFoundation* foundation)
//         {
...
//         }
//
//         void Box3DDebug::ShutdownPhysXPvd()
//         {
//             DisconnectFromPvd();
//             if (m_pvd)
//             {
...
//         }
        ...
        void Box3DDebug::Initialize(const DebugConfiguration& config)
        {
            m_config = config;
        }

        void Box3DDebug::UpdateDebugConfiguration(const DebugConfiguration& config)
        {
        ...
        const DebugConfiguration& Box3DDebug::GetDebugConfiguration() const
        {
            return m_config;
        }

        // const PvdConfiguration& Box3DDebug::GetPhysXPvdConfiguration() const
        // {
        //     return m_config.m_pvdConfigurationData;
        // }

        const DebugDisplayData& Box3DDebug::GetDebugDisplayData() const
        {
            return m_config.m_debugDisplayData;
        }

        void Box3DDebug::UpdateColliderProximityVisualization(const ColliderProximityVisualization& data)
        {
...
//             {
//                 case B3::Debug::PvdTransportType::File:
//                 {
...
//                     break;
//                 }
//                 case B3::Debug::PvdTransportType::Network:
//                 {
...
//         void Box3DDebug::DisconnectFromPvd()
//         {
// #ifdef AZ_PHYSICS_DEBUG_ENABLED
//             if (m_pvd)
//             {

...
namespace B3
{
    ...
    /// Component used to register an entity as a dynamic rigid body in the Box3D simulation.
    ...
    {
    public:
        AZ_COMPONENT(RigidBodyComponent, "{3C8C2A95-12C9-4234-A886-A1DDFE64DD0B}");
    ...
    private:
        ...
        void ApplyBox3DSpecificConfiguration();
        ...
        RigidBodyConfiguration
            m_box3DSpecificConfiguration; //!< Properties specific to Box3D which might not have exact equivalents in other physics engines.
    ...
    {
    public:
        AZ_RTTI(TransformForwardTimeInterpolator, "{B1B43C00-D3E1-4906-8B71-17F9A56D57E6}");
